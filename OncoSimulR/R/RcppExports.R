...
evalRGenotype <- function(rG, rFE, spPop, verbose, prodNeg, calledBy_, currentTime, multfact_) {
    .Call('OncoSimulR_evalRGenotype', PACKAGE = 'OncoSimulR', rG, rFE, spPop, verbose, prodNeg, calledBy_, currentTime, multfact_)
}

evalRGenotypeAndMut <- function(rG, rFE, muEF, spPop, full2mutator_, verbose, prodNeg, currentTime, multfact_) {
    .Call('OncoSimulR_evalRGenotypeAndMut', PACKAGE = 'OncoSimulR', rG, rFE, muEF, spPop, full2mutator_, verbose, prodNeg, currentTime, multfact_)
}
