...
evalRGenotype <- function(rG, rFE, verbose, prodNeg, calledBy_, currentTime) {
    .Call('OncoSimulR_evalRGenotype', PACKAGE = 'OncoSimulR', rG, rFE, verbose, prodNeg, calledBy_, currentTime)
}

evalRGenotypeAndMut <- function(rG, rFE, muEF, full2mutator_, verbose, prodNeg, currentTime) {
    .Call('OncoSimulR_evalRGenotypeAndMut', PACKAGE = 'OncoSimulR', rG, rFE, muEF, full2mutator_, verbose, prodNeg, currentTime)
}
