...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type muFactor(muFactorSEXP);
    Rcpp::traits::input_parameter< double >::type timeFactor(timeFactorSEXP);
