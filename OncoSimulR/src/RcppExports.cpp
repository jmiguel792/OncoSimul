...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type popReduce_(popReduce_SEXP);
...
// evalRGenotype
double evalRGenotype(Rcpp::IntegerVector rG, Rcpp::List rFE, Rcpp::IntegerVector spPop, bool verbose, bool prodNeg, Rcpp::CharacterVector calledBy_, double currentTime, Rcpp::CharacterVector multfact_, Rcpp::CharacterVector treduce_);
RcppExport SEXP OncoSimulR_evalRGenotype(SEXP rGSEXP, SEXP rFESEXP, SEXP spPopSEXP, SEXP verboseSEXP, SEXP prodNegSEXP, SEXP calledBy_SEXP, SEXP currentTimeSEXP, SEXP multfact_SEXP, SEXP treduce_SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type treduce_(treduce_SEXP);
    __result = Rcpp::wrap(evalRGenotype(rG, rFE, spPop, verbose, prodNeg, calledBy_, currentTime, multfact_, treduce_));
    return __result;
END_RCPP
}
// evalRGenotypeAndMut
Rcpp::NumericVector evalRGenotypeAndMut(Rcpp::IntegerVector rG, Rcpp::List rFE, Rcpp::List muEF, Rcpp::IntegerVector spPop, Rcpp::IntegerVector full2mutator_, bool verbose, bool prodNeg, double currentTime, Rcpp::CharacterVector multfact_, Rcpp::CharacterVector treduce_);
RcppExport SEXP OncoSimulR_evalRGenotypeAndMut(SEXP rGSEXP, SEXP rFESEXP, SEXP muEFSEXP, SEXP spPopSEXP, SEXP full2mutator_SEXP, SEXP verboseSEXP, SEXP prodNegSEXP, SEXP currentTimeSEXP, SEXP multfact_SEXP, SEXP treduce_SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type rG(rGSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type multfact_(multfact_SEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type treduce_(treduce_SEXP);
    __result = Rcpp::wrap(evalRGenotypeAndMut(rG, rFE, muEF, spPop, full2mutator_, verbose, prodNeg, currentTime, multfact_, treduce_));
    return __result;
END_RCPP
}

// evalRGenotypeAndMut - accessibleGenotypes
